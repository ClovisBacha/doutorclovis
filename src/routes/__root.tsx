...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dr. Clóvis Bacha — Ginecologia e Obstetrícia de Alto Risco" },
      { name: "description", content: "Dr. Clóvis Bacha, ginecologista e obstetra especialista em gestação de alto risco. Acolhimento, segurança e cuidado em cada etapa." },
      { name: "author", content: "Dr. Clóvis Bacha" },
      { property: "og:title", content: "Dr. Clóvis Bacha — Ginecologia e Obstetrícia de Alto Risco" },

...
const PLANS = [
  ...
  },
  {
    ...
    perSuffix: "",
    highlight: false,
    desc: "O mais alto de todos: presenteie centenas de pacientes e tenha o app com a sua própria marca.",
    features: [
      "Tudo do Elite",
      "🖤 250 convites premium/mês (gerados na hora)",
      "🏷️ Marca própria — o app com o seu nome e a sua cara (white-label)",

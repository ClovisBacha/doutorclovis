...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      "👩‍🍼 Até 50 pacientes · 🧠 1 cérebro (o seu) — sai a R$ 3,94/paciente",
  ...
  },
  {
    ...
    features: [
      "👩‍🍼 Até 150 pacientes · 🧠 1 cérebro — sai a R$ 2,31/paciente",
      "Tudo do Starter",
  ...
  },
  {
    key: "elite",
    name: "Elite",
    tagline: "Sua pequena equipe",
    monthly: 697,
    isFrom: false,
    perSuffix: "",
    highlight: false,
    desc: "Tudo do Pro para até 5 médicos + convites premium para presentear pacientes.",
    features: [
      "🧠 Até 5 cérebros (R$ 139/médico) · 👩‍🍼 300 pacientes por médico",
      "Tudo do Pro, para cada médico da equipe",
      "🎟️ 25 convites premium/mês — gere o código e envie para a paciente",
      "✓ Selo Elite verificado + prioridade na busca de médicos",
    ],
    cta: "Assinar Elite",
  },
  {
    ...
    features: [
      "🧠 Até 20 cérebros (R$ 100/médico) · 👩‍🍼 500 pacientes por médico",
      "Tudo do Elite",

 ...
 * R$ 29,90 na entrada (150) até R$ 999,00 (11.100) — e vive em
...
export function mensalidadeCentavos(
   ...
   * preço: tem uma escada de R$ 29,90 a R$ 999,00. Sem a quantidade, os dois
   * lugares que usam esta função passariam a mentir na mesma direção — o painel
   * diria "sua mensalidade é R$ 29,90" a quem paga R$ 999,00, e o MRR do

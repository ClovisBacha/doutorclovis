-- ============================================================================
-- APLICAR NO SQL EDITOR DO SUPABASE — direito ao esquecimento, a metade que
-- faltava
-- ============================================================================
-- Idempotente. Rode DEPOIS do APLICAR_EVENTOS_CLINICOS.
--
-- Uma auditoria testou o que sobrevive ao apagar uma conta: chat_messages,
-- chat_memory, epds_logs (rastreio de depressao, com ideacao), companion_invites
-- e brain_feedback continuavam no banco. A paciente pede exclusao, recebe a
-- confirmacao, e o texto continua la indexado por patient_id.
-- ============================================================================

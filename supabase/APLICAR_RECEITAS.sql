-- ============================================================================
-- APLICAR NO SQL EDITOR DO SUPABASE — receitas, pedidos de exame e orientacoes
-- ============================================================================
-- Idempotente. Nao depende de nenhum outro arquivo.
--
-- A aba "Ferramentas" do painel tem receituario e paineis de exame prontos, e
-- fazia duas coisas: copiar e imprimir. A receita existia so no papel que ela
-- levava, e o sistema — que tem a caixa onde o laudo volta — nunca soube que o
-- exame tinha sido pedido.
--
-- ATENCAO ao GRANT por coluna no fim do arquivo: a paciente pode marcar
-- "ja fiz" e NAO pode reescrever a posologia da propria receita. Validado em
-- Postgres 16.
-- ============================================================================

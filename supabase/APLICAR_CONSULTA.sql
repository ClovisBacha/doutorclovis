-- ============================================================================
-- APLICAR NO SQL EDITOR DO SUPABASE — a consulta como objeto do sistema
-- ============================================================================
-- Idempotente. Nao depende de nenhum outro arquivo.
--
-- Hoje a consulta presencial nao deixa rastro: `appointment_requests` e um
-- PEDIDO de horario e nem aponta para a conta da paciente (identifica por
-- e-mail digitado em formulario). Sem uma entidade com data, achados e conduta,
-- "o que mudou desde a ultima consulta?" nao tem de onde tirar o "desde".
-- ============================================================================

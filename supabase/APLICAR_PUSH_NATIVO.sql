-- ════════════════════════════════════════════════════════════════════════════
-- APLICAR NO SQL EDITOR DO SUPABASE — push nativo (iPhone e Android)
--
-- Idempotente: pode rodar mais de uma vez sem estragar nada.
--
-- Sem esta tabela, o app nativo REGISTRA o aparelho e falha em silêncio: a
-- paciente toca em "ativar avisos", vê "pronto", e nunca recebe nada.
-- ════════════════════════════════════════════════════════════════════════════
